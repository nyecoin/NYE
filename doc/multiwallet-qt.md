...
In order to support loading of multiple wallets in nyecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nyecoin.cpp.
...
Changes to nyecoin.cpp
----------------------
nyecoin.cpp is the entry point into nyecoin-qt, and as such, will require some minor modifications to provide hooks for
