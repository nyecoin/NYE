...
Intro
-----
NYECOIN (NYE) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. NYECOIN utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run nyecoin-qt.exe.

NYECOIN is the original NYECOIN client and it builds the backbone of the network.
However, it downloads and stores the entire history of NYECOIN transactions;
