...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "NYECOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NYECOIN features */
        {"NYECOIN", "masternode", &masternode, true, true, false},
        {"NYECOIN", "listmasternodes", &listmasternodes, true, true, false},
        {"NYECOIN", "getmasternodecount", &getmasternodecount, true, true, false},
        {"NYECOIN", "masternodeconnect", &masternodeconnect, true, true, false},
        {"NYECOIN", "masternodecurrent", &masternodecurrent, true, true, false},
        {"NYECOIN", "masternodedebug", &masternodedebug, true, true, false},
        {"NYECOIN", "startmasternode", &startmasternode, true, true, false},
        {"NYECOIN", "createmasternodekey", &createmasternodekey, true, true, false},
        {"NYECOIN", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"NYECOIN", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"NYECOIN", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"NYECOIN", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"NYECOIN", "getmasternodescores", &getmasternodescores, true, true, false},
        {"NYECOIN", "mnbudget", &mnbudget, true, true, false},
        {"NYECOIN", "preparebudget", &preparebudget, true, true, false},
        {"NYECOIN", "submitbudget", &submitbudget, true, true, false},
        {"NYECOIN", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"NYECOIN", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"NYECOIN", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"NYECOIN", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"NYECOIN", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"NYECOIN", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"NYECOIN", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"NYECOIN", "checkbudgets", &checkbudgets, true, true, false},
        {"NYECOIN", "mnsync", &mnsync, true, true, false},
        {"NYECOIN", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> NYECOIN-cli " + methodname + " " + args + "\n";
}
