...
#if defined(NDEBUG)
#error "NYECOIN cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uNYE) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // NYE: We use certain sporks during IBD, so check to see if they are
