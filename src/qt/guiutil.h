...
/** Utility functions used by the NYEcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render NYE addresses in monospace font
...
// Parse "nyecoin:" URI into recipient object, return true on successful parsing
