                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NYE Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NYE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nyecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NYECOIN"), this);
    aboutAction->setStatusTip(tr("Show information about NYECOIN"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NYECOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NYE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NYE addresses"));
    ...
    openAction->setStatusTip(tr("Open a nyecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NYECOIN help message to get a list with possible NYECOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NYECOIN client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NYECOIN network", "", count));
}
...
{
    QString strTitle = tr("NYECOIN"); // default title
