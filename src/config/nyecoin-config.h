/* src/config/nyecoin-config.h.  Generated from nyecoin-config.h.in by configure.  */
/* src/config/nyecoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "NYECOIN"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NYECOIN 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nyecoin"
