Contributing to NYECOIN
==================================

The NYECOIN project operates an open contributor model where anyone is
...
The following applies to code changes to the NYECOIN project, and is not to be
confused with overall NYECOIN Network Protocol consensus changes.

Whether a pull request is merged into NYECOIN rests with the project merge
...
Patches that change NYECOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the NYECOIN consensus, it must have been
...
The project leader is the release manager for each NYECOIN release.
