...
#   c) node1 mines 32 blocks, so now node 0 has 500000NYE, node 1 has 4250NYE, node2 has none.
#   d) node0 sends 601 NYE to node2, in two transactions (301 NYE, then 300 NYE).
