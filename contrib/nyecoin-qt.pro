...
RESOURCES += src/qt/nyecoin.qrc src/qt/nyecoin_locale.qrc

TRANSLATIONS += src/qt/locale/nyecoin_bg.ts \
                src/qt/locale/nyecoin_de.ts \
                src/qt/locale/nyecoin_en.ts \
                src/qt/locale/nyecoin_es.ts \
                src/qt/locale/nyecoin_fi.ts \
                src/qt/locale/nyecoin_fr.ts \
                src/qt/locale/nyecoin_it.ts \
                src/qt/locale/nyecoin_ja.ts \
                src/qt/locale/nyecoin_pl.ts \
                src/qt/locale/nyecoin_pt.ts \
                src/qt/locale/nyecoin_ru.ts \
                src/qt/locale/nyecoin_sk.ts \
                src/qt/locale/nyecoin_sv.ts \
                src/qt/locale/nyecoin_vi.ts \
                src/qt/locale/nyecoin_zh_CN.ts \
                src/qt/locale/nyecoin_zh_TW.ts
